# ============================================================================
# Gaia Agent Installer for Windows
# ============================================================================
# Installation script for Windows (PowerShell).
# Uses uv for fast Python provisioning and package management.
#
# Usage:
#   iex (irm https://github.com/User/gaia-agent/raw/main/scripts/install.ps1)
#
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://github.com/User/gaia-agent/raw/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
