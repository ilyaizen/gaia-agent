...
def format_banner_version_label() -> str:
    ...
    base = f"Gaia Agent v{VERSION} ({RELEASE_DATE})"
...
def build_welcome_banner(console: "Console", model: str, cwd: str,
    ...
    try:
        ...
        _hero = _bskin.banner_hero if hasattr(_bskin, 'banner_hero') and _bskin.banner_hero else GAIA_CADUCEUS
    except Exception:
        _bskin = None
        _hero = GAIA_CADUCEUS
    left_lines = ["", _hero, ""]
    ...
    if term_width >= 95:
        _logo = _bskin.banner_logo if _bskin and hasattr(_bskin, 'banner_logo') and _bskin.banner_logo else GAIA_AGENT_LOGO
        console.print(_logo)
        console.print()
